...
if __name__ == '__main__':
    df_raw = pd.read_csv("../data/electricity/electricity.txt.gz", usecols=[0], header=None)
    print(df_raw)
    ...
    data_loader = DataLoader(
        ...
        num_workers=0,
        drop_last=True)
    # for info, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(data_loader):
    #     if info == 1:
    #         break
    #     print(info)
